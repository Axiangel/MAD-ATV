...
for i in "$@" ;do
 ...
 -ec) echo "performing extended cleaning" && /system/bin/rm -rf /sdcard/Android/data/com.nianticlabs.pokemongo/files/UnityCache/Shared /sdcard/Download/* /storage/emulated/0/Download/* /storage/emulated/0/gapps.zip ;;
